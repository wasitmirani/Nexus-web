    ...
    <div class="row align-items-center justify-content-center h-100">
       <div class="col-md-5">
          <div class="card p-3">
             <div class="card-body">
                <div class="auth-logo">
                   <img src="/backend/assets/images/logo-1.png" class="img-fluid  rounded-normal  darkmode-logo" alt="logo">
                   <img src="/backend/assets/images/logo-dark.png" class="img-fluid rounded-normal light-logo" alt="logo">
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                   ...
                   <div class="row">
                      <div class="col-lg-12">
                         <div class="form-group">
                            <label class="text-secondary">E-Mail Address</label>
                   ...
                   <div class="col-lg-12 mt-3">
                        <p class="mb-0 text-center">Don't have an account? <a href="#">Sign Up</a></p>
                   </div>
                </form>
             </div>
          </div>
