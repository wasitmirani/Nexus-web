<nav class="iq-sidebar-menu">
    <ul id="iq-sidebar-toggle" class="side-menu">
        ...
        <li class=" sidebar-layout">
            <a href="/backend/app/todo.html" class="svg-icon">
                <i class="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewbox="0 0 24 24" stroke="currentColor">
        ...
        <li class=" sidebar-layout">
            <a href="/backend/app/calendar.html" class="svg-icon">
                <i class="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewbox="0 0 24 24" stroke="currentColor">
        ...
        <li class=" sidebar-layout">
            <a href="/backend/app/chat.html" class="svg-icon">
                <i class="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewbox="0 0 24 24" stroke="currentColor">
         ...
         <li class=" sidebar-layout">
            <a href="/backend/app/user-profile.html" class="svg-icon">
                <i class="">
